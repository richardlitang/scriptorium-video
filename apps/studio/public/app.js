...
// Review panel now owned by React SPA (Slice 10)
const reviewController = { getIssues: () => [], refresh: async () => [] };
    }
  }
});
...
// All legacy event handler wiring removed — UI now owned by React SPA.
