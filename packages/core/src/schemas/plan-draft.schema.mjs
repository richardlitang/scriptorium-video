export const PlanDraftSchema = {
  ...
  properties: {
      ...
      properties: {
        ...
        characters: {
          ...
          items: {
            type: "object",
            additionalProperties: false,
            required: ["id", "name", "role", "age", "body", "face", "hair", "wardrobe", "avoid"],
            properties: {
              id: { type: "string" },
              name: { type: "string" },
              role: { type: "string" },
        ...
        locations: {
          ...
          items: {
            type: "object",
            additionalProperties: false,
            required: ["id", "name", "description", "continuityNotes", "avoid"],
            properties: {
              id: { type: "string" },
              name: { type: "string" },
    ...
    quality: {
      ...
      additionalProperties: false,
      required: [
        "estimatedSourceCoverageRatio",
        "containsInventedChannelCta",
        "introHookPlacement",
        "orderingConfidence",
        "coverageNotes",
      ],
      properties: {
        ...
        introHookPlacement: {
          type: "string",
          enum: ["none", "opening", "middle", "late_or_ending"],
        },
          ...
          beats: {
            ...
            items: {
              ...
              properties: {
                ...
                cropRisk: { type: "string", enum: ["low", "medium", "high"] },
                motionStrength: { type: "string", enum: ["subtle", "medium", "strong"] },
                referenceIds: { type: "array", items: { type: "string" } },
                referencePriority: { type: "string", enum: ["low", "medium", "high"] },
                sfxCues: {
                  type: "array",
                  items: {
                    type: "object",
                    ...
                    properties: {
                      ...
                      placement: {
                        type: "string",
                        enum: ["beat_start", "beat_end", "key_point", "manual"],
                      },
                      ...
                      proximity: {
                        type: "string",
                        enum: ["distant", "room", "close", "close_mic"],
                      },
                ...
                silenceWindows: {
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      placement: {
                        type: "string",
                        enum: ["beat_start", "beat_end", "before_reveal", "manual"],
                      },
                      offsetSeconds: { type: "number" },
                      durationSeconds: { type: "number" },
