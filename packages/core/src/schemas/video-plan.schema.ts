...
export const SoundCueIntentSchema = z
  .object({
    id: z.string(),
    kind: z.string(),
...
export const EditorialCueSchema = z
  .object({
    id: z.string(),
    type: z.enum([
      "smash_cut",
...
export const SilenceWindowSchema = z
  .object({
    id: z.string(),
...
export const EndingPolicySchema = z
  .object({
...
export const BeatEditorialSchema = z
  .object({
...
export const MediaIntentSchema = z
  .object({
    ...
    role: z
      .enum(["primary_visual", "background", "overlay", "broll", "screen"])
...
export const BeatTimingIntentSchema = z
  .object({
    ...
    mediaPolicy: z
      .enum(["cut_to_audio", "loop_or_freeze", "fit_audio_to_media", "manual"])
...
export const VoiceDirectionSchema = z
  .object({
    ...
    pauseBeforeMs: z.number().int().min(0).max(1200).optional(),
...
export const VoiceDirectionOverrideSchema = z
  .object({
...
export const CaptionDirectionOverrideSchema = z
  .object({
...
export const ProductionDirectionSchema = z
  .object({
...
export const DirectionMetaSchema = z
  .object({
